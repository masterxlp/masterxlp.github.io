...
$$
\begin{align}
&unigram\ :\ p(w_1, w_2, \cdots, w_m) = p(w_1) \cdot p(w_2) \cdots p(w_m) \tag{3} \\
&bigram\ :\ p(w_1, w_2, \cdots, w_m) = p(w_1) \cdot p(w_2|w_1) \cdot p(w_3|w_2) \cdots p(w_m|w_{m-1}) \tag{4} \\
&trigram\ :\ p(w_1, w_2, \cdots, w_m) = p(w_1) \cdot p(w_2|w_1) \cdot p(w_3|w_1, w_2) \cdots p(w_m|w_{m-1}, w_{m-2}) \tag{5} \\
\end{align}
$$
